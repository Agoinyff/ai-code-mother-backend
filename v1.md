...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|chatHistoryCursorQueryRequest|ChatHistoryCursorQueryRequest|body|true|ChatHistoryCursorQueryRequest|ChatHistoryCursorQueryRequest|
|&emsp;&emsp;appId|||false|integer(int64)||
|&emsp;&emsp;pageSize|||false|integer(int32)||
|&emsp;&emsp;lastTime|||false|string(date-time)||
|&emsp;&emsp;lastId|||false|integer(int64)||
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|BaseResponseCursorPageVoChatHistoryVo|
...
|code||integer(int32)|integer(int32)|
|message||string||
|data||CursorPageVoChatHistoryVo|CursorPageVoChatHistoryVo|
...
|&emsp;&emsp;nextCursor||CursorInfo|CursorInfo|
|&emsp;&emsp;&emsp;&emsp;lastTime||string||
|&emsp;&emsp;&emsp;&emsp;lastId||integer||
...
**接口地址**:`/api/chatHistory/admin/list/page`
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|chatHistoryAdminQueryRequest|ChatHistoryAdminQueryRequest|body|true|ChatHistoryAdminQueryRequest|ChatHistoryAdminQueryRequest|
|&emsp;&emsp;pageNum|||false|integer(int32)||
|&emsp;&emsp;pageSize|||false|integer(int32)||
|&emsp;&emsp;sortField|||false|string||
|&emsp;&emsp;sortOrder|||false|string||
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|BaseResponsePageChatHistoryVo|
...
|code||integer(int32)|integer(int32)|
|message||string||
|data||PageChatHistoryVo|PageChatHistoryVo|
|&emsp;&emsp;records||array|ChatHistoryVo|
|&emsp;&emsp;&emsp;&emsp;id||integer||
|&emsp;&emsp;&emsp;&emsp;message||string||
|&emsp;&emsp;&emsp;&emsp;messageType||string||
...
|&emsp;&emsp;&emsp;&emsp;column||string||
|&emsp;&emsp;&emsp;&emsp;asc||boolean||
|&emsp;&emsp;optimizeCountSql||PageChatHistoryVo|PageChatHistoryVo|
|&emsp;&emsp;searchCount||PageChatHistoryVo|PageChatHistoryVo|
|&emsp;&emsp;optimizeJoinOfCountSql||boolean||
|&emsp;&emsp;maxLimit||integer(int64)||
|&emsp;&emsp;countId||string||
|&emsp;&emsp;pages||integer(int64)||
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|appAdminQueryRequest|AppAdminQueryRequest|body|true|AppAdminQueryRequest|AppAdminQueryRequest|
|&emsp;&emsp;pageNum|||false|integer(int32)||
|&emsp;&emsp;pageSize|||false|integer(int32)||
|&emsp;&emsp;sortField|||false|string||
|&emsp;&emsp;sortOrder|||false|string||
